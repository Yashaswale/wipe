        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            Building the future of Global{' '}
              <span className="text-emerald-600">Mobility</span> <br/>
              with 
              <span className="text-emerald-600"> Wipe</span>
            </h2>
          </div>
          ...
          <div className="space-y-6 lg:text-right lg:mt-14">
            ...
            <div className="flex items-center lg:justify-end space-x-3">
              ...
              <a 
                ...
                className="inline-flex items-center bg-emerald-600 hover:bg-emerald-700 text-white px-3 py-2 rounded-full transition-colors duration-200 group"
